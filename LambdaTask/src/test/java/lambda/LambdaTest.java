...
public class LambdaTest {
    ...
    public void getMethodOneTest() {
        ...
        assertEquals(METHOD_ONE_TEST_STRING, Lambda.methodOne(new ZeroArgsInterface() {
            @Override
    ...
    public void getMethodTwoTest() {
        ...
        OneArgInterface oneArgFunctionalInterface = new OneArgInterface() {
            @Override
    ...
    public void getMethodThreeTest() {
        ...
        TwoArgsInterface twoArgsFunctionalInterface = new TwoArgsInterface() {
            @Override
